                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-6 d-flex stat my-3">
                                        <div class="mx-auto">
                                            ...
                                            <h6 class="text-success"><i class="icon ion-md-arrow-dropup-circle"></i> 50%
                                            </h6>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-6 d-flex stat my-3">
                                        <div class="mx-auto">
                                            ...
                                            <h6 class="text-success"><i class="icon ion-md-arrow-dropup-circle"></i> 25%
                                            </h6>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body pt-2">
                                        <div class="d-flex border-bottom py-2">
                                            ...
                                            <div class="align-self-center">
                                                <h6 class="d-inline-block mb-0">1263</h6><span
                                                    class="badge badge-warning ml-2">equipo descompuesto</span>
                                        ...
                                        <div class="d-flex border-bottom py-2">
                                            ...
                                            <div class="align-self-center">
                                                <h6 class="d-inline-block mb-0">5684</h6><span
                                                    class="badge badge-success ml-2">Equipo entregado</span>
                                                <small class="d-block text-muted">ver</small>
                                            </div>
                                        </div>
